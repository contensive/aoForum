        ...
        public class ForumClass : AddonBaseClass {
            ...
            public override object Execute(CPBaseClass CP) {
                ...
                try {
                    ...
                    var viewModel = ForumViewModel.create(CP, settings);
                    if ((viewModel == null))
                        throw new ApplicationException("Could not create design block view model.");
                    result = Nustache.Core.Render.StringToString(DesignBlockController.getLayoutByGuid(CP,guidForumLayout,"Forum Layout", Contensive.Addons.Forum.Properties.Resources.ForumLayout), viewModel);
                    // 
